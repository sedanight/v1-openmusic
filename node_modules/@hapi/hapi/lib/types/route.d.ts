...
import { MergeType, ReqRef, ReqRefDefaults, MergeRefs, AuthMode } from '@hapi/hapi/lib/types/request';
import { RouteRequestExtType, RouteExtObject, Server } from '@hapi/hapi/lib/types/server';
import { Lifecycle, Json, HTTP_METHODS_PARTIAL } from '@hapi/hapi/lib/types/utils';
